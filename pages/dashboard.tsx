...
const Dashboard = () => {
  ...
  return (
    <>
      <div className='p-6'>
        <h1 className="font-bold text-5xl text-gray-800">Hallo, {user.name} </h1>
        <p className="pt-8 md:pt-4 text-gray-600">Selamat datang di myarchery.id</p>
        <div className="grid grid-cols-4 gap-4 mt-4">
          <div>
            <div>
              <div className="card-shadow max-w-sm rounded-lg border border-gray-200 bg-white shadow-lg h-[200px]">
          ...
          <div>
            <div>
              <div className="card-shadow max-w-sm rounded-lg border border-gray-200 bg-white shadow-lg h-[200px]">
                <div className="text-right p-4">
                  <span className="text-xs text-gray-500 tracking-widest uppercase"> Neque porro quisquam</span>
                </div>
